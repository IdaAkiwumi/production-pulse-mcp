...
[![CI](https://github.com/idaakiwumi/production-pulse-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/idaakiwumi/production-pulse-mcp/actions)
[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue.svg)](https://www.python.org/downloads/)
[![MCP Protocol](https://img.shields.io/badge/MCP-Protocol-orange)](https://modelcontextprotocol.io/)
[![Streamlit](https://static.streamlit.io/badges/streamlit_badge_black_white.svg)](https://production-pulse-demo.streamlit.app)
...
![Mission Control Dashboard](https://raw.githubusercontent.com/idaakiwumi/production-pulse-mcp/main/assets/dashboard-screenshot.png)
...
**The Solution:**  
Production Pulse exposes **MCP Tools** that let an AI agent:
...
```bash
# 1. Install
pip install production-pulse-mcp

# 2. Run the MCP server (stdio transport for Claude Desktop)
python -m production_pulse.server
...
# ~/Library/Application\ Support/Claude/claude_desktop_config.json
{
  "mcpServers": {
    "production-pulse": {
      "command": "python",
      "args": ["-m", "production_pulse.server"]
    }
  }
}
